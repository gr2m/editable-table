function editableTable($) {
  ...
  var EditableTable = function(el) {
    ...
    function handleInsert(event) {
      ...
      if (event.target === lastRemovedRow) {
        // [3]
  ...
  $(document).on(
    "focus.bs.editableTable.data-api",
    "table[data-editable-spy]",
    function(event) {
